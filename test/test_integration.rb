...
class TC_Database_Integration < SQLite3::TestCase
  ...
  def test_table_info_with_defaults_for_version_3_3_8_and_higher
    @db.transaction do
      ...
      assert_equal(
        { "name" => "a", "type" => "string", "dflt_value" => nil, "notnull" => 0, "cid" => 0, "pk" => 0 },
        data[0],
      )
      assert_equal(
        { "name" => "b", "type" => "string", "dflt_value" => "Hello", "notnull" => 0, "cid" => 1, "pk" => 0 },
        data[1],
      )
      assert_equal(
        { "name" => "c", "type" => "string", "dflt_value" => "--- []\n", "notnull" => 0, "cid" => 2, "pk" => 0 },
        data[2],
      )
    end
  end
  ...
  def test_table_info_without_defaults_for_version_3_3_8_and_higher
    @db.transaction do
      ...
      assert_equal(
        { "name" => "b", "type" => "integer", "dflt_value" => nil, "notnull" => 0, "cid" => 1, "pk" => 0 },
        data[1],
      )
    end
  end
